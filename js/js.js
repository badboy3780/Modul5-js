...
const getAllNames = arr => arr.map(userName => userName.name);
 ...
 */
const getUsersByEyeColor = (arr, color) => arr.filter(userColor => userColor.eyeColor == color);
 ...
 */
const getUsersByGender = (arr, gender) => arr.filter(userGender => userGender.gender == gender).map(userName => userName.name);
 ...
 */
const getUserByEmail = (arr, email) => arr.filter(userEmail => userEmail.email == email);
 ...
 */
const getTotalBalance = arr => arr.reduce((users, balance) => users + balance.balance, 0);
